...
<ul class="contact_details">
  <?php
    ...
    if ($header_phone = mfn_opts_get('header-phone')) {
      echo '<li class="phone"><i class="icon-call"></i><a href="tel:'. esc_attr(str_replace(' ', '', $header_phone)) .'">'. esc_html($header_phone) .'</a></li>';
    }
    if ($header_phone_2 = mfn_opts_get('header-phone-2')) {
      echo '<li class="phone"><i class="icon-call"></i><a href="tel:'. esc_attr(str_replace(' ', '', $header_phone_2)) .'">'. esc_html($header_phone_2) .'</a></li>';
    }
