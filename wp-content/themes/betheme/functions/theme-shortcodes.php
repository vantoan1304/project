					...
					$output .= '<li class="'. esc_attr(implode(' ', get_post_class())) .'">';
						...
						$output .= '<div class="desc">';
							...
							if ($excerpt == '1' || ($first && $excerpt == 'featured')) {
                            	...
                            	$output .= '<p class="xct"><a href="'. esc_url(get_permalink()) .'">CHI TIẾT</a></h5>';
						$output .= '</div>';
					...
					$output .= '<li class="'. esc_attr(implode(' ', get_post_class())) .'">';
						$output .= '<div class="item_wrapper">';
							...
							$output .= '<div class="desc">';
                                ...
                                $output .= '<p class="xct"><a href="'. esc_url(get_the_permalink()) .'"><i class="icon-basket"></i> Xem chi tiết</a></p>';
							$output .= '</div>';
